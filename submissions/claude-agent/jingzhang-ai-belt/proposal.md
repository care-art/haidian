...
本方案提出百年京张AI创新带的总体概念为"**百年京张·算轨新生**"（Centennial Jing-Zhang: From Railway to Compute Rails）。

**核心隐喻**："铁轨"与"算轨"的百年对话——
1909年，詹天佑在北京西北郊的燕山余脉间修筑了中国第一条自主设计的铁路，让蒸汽时代的钢轨穿越了地形与偏见的双重阻隔。一百年后，同样的地理走廊上，数据流取代了列车流，AI算力取代了蒸汽动力，但"穿越阻隔、自主创新"的精神内核从未改变。**京张铁路是中国工程自主创新的第一个物理载体，今天我们要打造的是一条AI自主创新的精神走廊**——同样的路线，不同的轨距，同一个方向。

**命名体系**：
- 中文主名称：百年京张AI创新带
- 英文主名称：Centennial Jing-Zhang AI Innovation Belt
- 概念名：算轨新生 / Compute Rails Reborn
- 品牌口号：百年铁轨，一脉算轨（A Century of Rails, One Line of Compute）

**命名逻辑**：
- "百年京张"——不是简单纪念历史，而是将京张铁路的自主创新精神作为当代AI创新的**精神谱系**
- "算轨"——将AI基础设施（算力、算法、数据）比喻为新时代的"轨道"，延续铁路的空间秩序感
- "新生"——不是推倒重来，而是在百年铁轨的遗产上叠加AI时代的创新层
- 英文名"Compute Rails Reborn"直接对应"算轨新生"，便于国际传播
...
本方案提出"**一脉三站双翼十二节点**"的总体空间结构，以京张铁路的"轨迹—站点—里程"空间秩序为原型转译：

- **一脉**：京张遗址公园活力带——不是简单的"南北主轴"，而是百年铁轨的物理遗产与AI创新带精神载体的重叠层。它承担了历史记忆、生态廊道、创新交往三重功能 [data:geometry/green_space.geojson#GS-001]。
- **三站**：众智园"验证站"、AI原点社区"共创站"、大钟寺"体验站"——每个重点区不只是功能节点，而是AI创新链上不同阶段的"车站"：基础研究在这里验证（众智园），成果转化在这里孵化（原点社区），城市应用在这里体验（大钟寺）。
- **双翼**：中关村科技服务翼（西）、小月河场景赋能翼（东）——分别承担要素配置和场景试验的支撑功能。
- **十二节点**：沿脉分布的12个AI场景节点，每个节点对应一张场景卡、一个用户画像组、一套运营协议。

**空间结构的独特性**：不同方案用不同隐喻组织空间——有的用"缝合"（横向穿越），有的用"信标"（信号语言），有的用"共生"（生态关系）。本方案用"铁轨—算轨"的**时间纵深**组织空间：一百年前的铁轨是物理的、固定的、单向的；一百年的算轨是虚拟的、可进化的、多向的。两者在同一地理走廊上叠加，形成独特的"时间叠层"空间策略。
...
| 场景ID | 场景名称 | 领域 | 空间位置 | 服务对象 | 隐私边界 | 人工复核 | 运行协议 |
|--------|----------|------|----------|----------|----------|----------|----------|
| S-001 | AI交通信号优化 | AI+交通 | 西土城路/学院路交叉口 | 通勤人群 | 匿名化流量数据 | 实时监控 | 场景护照+S-001 |
| S-002 | AI医疗影像辅助诊断 | AI+医疗 | AI原点社区健康中心 | 患者 | 医疗数据脱敏 | 医生复核 | 场景护照+S-002 |
| S-003 | AI个性化学习助手 | AI+教育 | 高校配套区 | 学生 | 学习行为数据 | 教师监督 | 场景护照+S-003 |
| S-004 | AI法律咨询服务 | AI+法律 | 大钟寺AI服务街区 | 市民 | 法律咨询记录 | 律师确认 | 场景护照+S-004 |
| S-005 | AI智能家居管家 | AI+生活服务 | 人才公寓 | 居民 | 家庭行为数据 | 用户授权 | 场景护照+S-005 |
| S-006 | AI城市运行数字孪生 | AI+治理 | 众智园AI治理中心 | 政府/研究者 | 城市运行数据 | 权限控制 | 场景护照+S-006 |
| S-007 | AI内容创作工坊 | AI+文化 | 大钟寺AI内容街区 | 创作者 | 创作内容 | 用户自主 | 场景护照+S-007 |
| S-008 | AI智能体协作空间 | AI原生 | 京张遗址公园AI广场 | 开发者 | 协作过程数据 | 社区公约 | 场景护照+S-008 |
| S-009 | AI自动驾驶测试场 | AI+交通 | 众智园测试区 | 企业/研究者 | 测试数据 | 安全审批 | 场景护照+S-009 |
| S-010 | AI能源管理优化 | AI+市政 | 全带分布式能源节点 | 居民/企业 | 能耗数据 | 系统监控 | 场景护照+S-010 |
| S-011 | AI公共空间互动装置 | AI+公共空间 | 京张遗址公园各节点 | 公众 | 匿名交互数据 | 无敏感数据 | 场景护照+S-011 |
| S-012 | AI产业大脑可视化 | AI+产业 | 众智园AI创新公园 | 政府/企业 | 产业经济数据 | 权限分级 | 场景护照+S-012 |

**场景护照系统**：

每张场景卡对应一张"场景护照"，包含六个字段：

| 字段 | 说明 | S-001 示例 |
|------|------|------------|
| **场景ID** | 唯一标识 | S-001 |
| **运行状态** | 绿色=可体验 / 黄色=受控测试 / 红色=停用 | 黄色（受控测试） |
| **数据边界** | 采集什么数据、保留多久、谁可访问 | 匿名化流量数据，7天自动删除 |
| **人工兜底** | 当AI失效时的替代方案 | 人工信号控制，30秒内切换 |
| **到期时间** | 场景自动到期的日期（防止永久部署） | 2027-08-09（1年期试点） |
| **回滚机制** | 如何安全退出和还原 | 一键切换至人工控制模式 |

**停止条件**：当人工复核发现连续3次误判、或用户投诉率超过5%、或数据泄露风险被评估为高，场景自动进入红色状态并启动回滚。
...
每个地标都对应京张铁路的一个历史元素，形成"铁轨—算轨"的隐喻对应：

| 地标 | 历史原型 | AI转译 | 空间位置 |
|------|----------|--------|----------|
| **"人字坡"** | 京张铁路最著名的人字形展线（青龙桥段） | AI创新链的"分叉—汇聚"结构可视化 | 众智园南部入口 |
| **"清华园站"** | 1909年京张铁路起点，詹天佑主持修建 | AI原始创新起点的精神地标 | AI原点社区核心广场 |
| **"大钟"** | 大钟寺古钟，声音传播的象征 | AI声音交互与智能终端的公共艺术装置 | 大钟寺站广场 |

**"人字坡"地标**：
- 物理形态：一个大型的地面艺术装置，用不锈钢和LED模拟"人"字形铁路展线，同时在夜间投射AI神经网络的数据流动视觉效果
- 隐喻：詹天佑在青龙桥设计的"人字形"展线是为了解决地形高差的工程创新；今天的"人字形"代表AI创新链的分叉（基础研究→应用研究→产业化）与汇聚（跨学科协作）
- 互动：访客可以通过手势控制LED数据流的"分叉"与"汇聚"模式，体验AI创新的协同过程
- 文化关联：直接呼应1909年詹天佑的工程智慧，形成百年对话

**"清华园站"地标**：
- 物理形态：一个开放的纪念广场，保留了清华园火车站旧址的记忆边界（用低矮的石质界碑标示），广场地面嵌入LED灯带模拟铁轨延伸
- 隐喻：清华园站是京张铁路的起点，也是今天AI原始创新的起点——从基础研究中"发车"
- 互动：广场上设置AI时间胶囊，访客可以输入对AI未来的期望，系统自动生成一个"抵达时间"（如"2030年的北京会看到..."）
- 文化关联：呼应"一百年前从这里发车，一百年后从这里出发"的时间纵深

**"大钟"地标**：
- 物理形态：一个结合声音交互的公共艺术装置，外形致敬大钟寺古钟，但用现代材料（曲面玻璃+金属）和AI技术重新诠释
- 隐喻：古钟的声音传播功能 → AI时代的"声音"（数据、算法、决策）如何影响城市
- 互动：访客可以对装置"发声"，AI实时分析声音特征并生成对应的视觉图案，展示AI声音识别与生成能力
- 文化关联：大钟寺不仅是历史地标，也是今天AI智能终端和内容消费的创新聚集区，形成历史与当下的空间叠合
...
为区分不同来源的支持力度，本方案建立四级证据体系：

| 等级 | 定义 | 本方案采用 | 使用范围 |
|------|------|-----------|----------|
| **A. 可直接计算** | 由 GeoJSON 几何直接复算，无需外部数据 | provisional 边界面积、用地比例 | 全部指标计算 |
| **B. 公告锚定** | 来自官方公告/任务书的明确文字 | 三层范围面积、重点区名称 | 范围界定、任务覆盖 |
| **C. 概念推断** | 基于公开资料的合理推定 | 用地布局、建筑概念 | 概念设计章节 |
| **D. 待验证假设** | 需要未来数据确认才能判断 | 控规条件、现状建筑、文保边界 | 标注为 unknown |

正文中所有数字均带口径标签，例如"临时复算约 1,929,202 m2 [A级]"、"公告值 1,921,000 m2 [B级]"、"概念估算约 470,000 m2 [C级]"、"待官方控规条件确认 [D级]"。
